...
class QuestionnaireSectionDecorator(context: Context, @Dimension val startOffset: Int) :
    ...
    private fun isSection(view: View, parent: RecyclerView): Boolean {
