...
class OnboardingConsentViewModelTest {
    ...
    @Test
    fun `given a case with no tasks and a paired user and symptoms known, when consent is given, then consent should be stored and add contacts should be opened`() = runBlockingTest {
        // given
    ...
    @Test
    fun `given a case with no tasks and a paired user and no symptoms known, when consent is given, then consent should be stored and add symptoms should be opened`() = runBlockingTest {
        // given
    ...
    @Test
    fun `given a case with tasks and a paired user, when consent is given, then consent should be stored and tasks should be opened`() = runBlockingTest {
        // given
    ...
    @Test
    fun `given a case without tasks and no paired user, when consent is given, then consent should be stored and add symptoms should be opened`() = runBlockingTest {
        // given
